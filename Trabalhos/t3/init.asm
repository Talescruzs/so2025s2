...
; cria 3 outros processos, que executam p1, p2 e p3
; espera os 3 terminarem e se mata
;
...
limpa    define 10
         ...
         ; cria o primeiro
         cargi prog1  ; nome do programa a executar
         trax
         cargi SO_CRIA_PROC
         chamas
         armm pid1  ; o PID do processo é retornado em A
...
morre
         ...
         cargi SO_MATA_PROC
         chamas
         ; não deve chegar aqui, a não ser que tenha ressucitamento
         cargi nao_morri
         chama impstr
